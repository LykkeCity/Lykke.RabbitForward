...
using Lykke.RabbitForward.DependencyInjection;
using Lykke.RabbitForward.Models;
...
namespace Lykke.RabbitForward
{
    ...
    public class Startup
    {
        ...
        {
            var appSettings = settings.RabbitForwardService;
            ...
            {
                logToAzureStorage = new LykkeLogToAzureStorage("Lykke.RabbitForward", new AzureTableStorage<LogEntity>(
